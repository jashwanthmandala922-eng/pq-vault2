...
class MutualAuthenticator {
    ...
    private fun initializeDHKeyPair() {
        ...
        keyGen.initialize(DHParameterSpec(BigInteger("00"+(
            ...
            "E7F9D8B1CFB1A0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B"
        ).toUpperCase(), 16), 256, 2)), SecureRandom())
